...
<html xml:lang="en" xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script type="text/javascript" src="js/love/jscex/jscex.min.js"></script>
        <script type="text/javascript" src="js/love/jscex/jscex-parser.js"></script>
        <script type="text/javascript" src="js/love/jscex/jscex-jit.js"></script>
        <script type="text/javascript" src="js/love/jscex/jscex-builderbase.min.js"></script>
        <script type="text/javascript" src="js/love/jscex/jscex-async.min.js"></script>
        <script type="text/javascript" src="js/love/jscex/jscex-async-powerpack.min.js"></script>
    ...
    <body>
        <!-- 浮动广告代码开始 -->
<div id="ShowAD" style="position: absolute; z-index: 100; top: 334px; left: 15px;">
    <div style="width:150px;height:18px;font-size:14px;font-weight:bold;text-align:center;CURSOR: hand;" onclick="closead();"><font color="ff0000">关闭</font></div>
    <a href="http://bigeone.cn/love/index.html" target="_blank" title="title" onclick="closead();">
        <img border="0" alt="alt" src="img/bg.png" style="width: 150px;height: 203px"></a>
</div>
<script>
